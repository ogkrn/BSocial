  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Club Pages</h1>
          <p className="text-gray-500">Discover and follow university clubs</p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="card text-center py-12">
          ...
          <p className="text-gray-500 mb-4">Be the first to create a club page!</p>
          ...
          {data?.pages?.map((page: Page) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-primary-100 to-secondary-100 flex items-center justify-center text-2xl">
                  {page.avatarUrl ? (
                    <img
                      src={page.avatarUrl}
                      alt={page.name}
